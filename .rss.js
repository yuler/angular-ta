...
function generateXML (data){
    ...
    data.items.forEach(function(item) {
        ...
        //edit source code
        var summary = item.description.substring(0,200).replace(/<[^>]+>/g,"");
        ifTruePush(item.description, item_values, { description:  { _cdata: summary+'.......' } });
        ifTruePush(item.description, item_values, { 'content:encoded':  { _cdata: item.description } });
